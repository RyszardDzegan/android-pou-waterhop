...
public class ApplicationFlowControllerTest {
    ...
    public void Constructor_throws_exception_when_first_argument_is_null() {
        ...
        GameStateRequiredListener gameStateRequiredListener = mock(GameStateRequiredListener.class);
    ...
    public void Constructor_throws_exception_when_second_argument_is_null() {
        thrown.expect(IllegalArgumentException.class);
        GameActionRequiredListener gameActionRequiredListener = mock(GameActionRequiredListener.class);
    ...
    public void Game_state_EMPTY_EMPTY_implicates_JUMP2_action() {
        GameActionRequiredListener gameActionRequiredListener = mock(GameActionRequiredListener.class);
        GameStateRequiredListener gameStateRequiredListener = mock(GameStateRequiredListener.class);
        ApplicationFlowController sut = new ApplicationFlowController(gameActionRequiredListener, gameStateRequiredListener);
